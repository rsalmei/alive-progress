...
YELLOW_BOLD, YELLOW_DIM, YELLOW_IT, YELLOW_UNDER = YELLOW.mix(
    BOLD, DIM, ITALIC, UNDERLINE
)
RED_BOLD, RED_DIM, RED_IT, RED_UNDER = RED.mix(BOLD, DIM, ITALIC, UNDERLINE)
MAGENTA_BOLD, MAGENTA_DIM, MAGENTA_IT, MAGENTA_UNDER = MAGENTA.mix(
    BOLD, DIM, ITALIC, UNDERLINE
)
CYAN_BOLD, CYAN_DIM, CYAN_IT, CYAN_UNDER = CYAN.mix(BOLD, DIM, ITALIC, UNDERLINE)
ORANGE_BOLD, ORANGE_DIM, ORANGE_IT, ORANGE_UNDER = ORANGE.mix(
    BOLD, DIM, ITALIC, UNDERLINE
)
