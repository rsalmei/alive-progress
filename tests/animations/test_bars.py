...
@pytest.mark.parametrize(
    "chars, percent, end, expected",
    [
        ("", -0.5, False, "|0123456789|"),
        ("=", -0.5, False, "|0123456789|"),
        ("_-=", -0.5, False, "|0123456789|"),
        ("", -0.5, True, "|!         |"),
        ("=", -0.5, True, "|!         |"),
        ("_-=", -0.5, True, "|!         |"),
        ("😺", -0.5, True, "|!         |"),
        ("_-😺", -0.5, True, "|!         |"),
        ("", 0.0, False, "|0123456789|"),
        ("=", 0.0, False, "|0123456789|"),
        ("_-=", 0.0, False, "|0123456789|"),
        ("", 0.0, True, "|!         |"),
        ("=", 0.0, True, "|!         |"),
        ("_-=", 0.0, True, "|!         |"),
        ("😺", 0.0, True, "|!         |"),
...
def test_bar_tip_background(chars, percent, end, expected, show_marks):
    bar = bar_factory(
        chars=chars,
        tip="@#$%>",
        background="0123456789xxxxxxxxxxxxxxxxxxxxxxxxxxx",
        borders="||",
        errors="!x",
    )(10)
...
@pytest.mark.parametrize(
    "chars, tip, background, percent, end, expected",
    [
        ("", ">", "", -0.5, False, "|          |"),
        ("", ">", "0123", -0.5, False, "|0123012301|"),
        ("", "@#$%>", "", -0.5, False, "|          |"),
        ("=", "", "", -0.5, False, "|          |"),
        ("=", "", ".", -0.5, False, "|..........|"),
        ("=", ">", "", -0.5, False, "|          |"),
        ...
        ("_-=", "@#$%>", "", 0.0, True, "|!         |"),
        ("", ">", "", 0.15, False, "| >        |"),
        ("", ">", "0123", 0.15, False, "|0>23012301|"),
        ("", "@#$%>", "", 0.15, False, "|%>        |"),
        ("=", "", "", 0.15, False, "|==        |"),
        ("=", "", ".", 0.15, False, "|==........|"),
        ("=", ">", "", 0.15, False, "|=>        |"),
        ("=", ">", "0123", 0.15, False, "|=>23012301|"),
        ("=", "@#$%>", "", 0.15, False, "|%>        |"),
        ("_-=", "", "", 0.15, False, "|=_        |"),
        ("_-=", "", ".", 0.15, False, "|=_........|"),
        ("_-=", ">", "", 0.15, False, "|->        |"),
        ("_-=", ">", "0123", 0.15, False, "|->23012301|"),
        ("_-=", "@#$%>", "", 0.15, False, "|$%>       |"),
        ("", ">", "", 0.15, True, "| >!       |"),
        ("", ">", "0123", 0.15, True, "|0>!       |"),
        ("", "@#$%>", "", 0.15, True, "|%>!       |"),
...
def test_bar_draw(chars, tip, background, percent, end, expected):
    bar = bar_factory(
        chars=chars, tip=tip, background=background, borders="||", errors="!x"
    )(10)
    rendition = bar.end(percent=percent) if end else bar(percent=percent)
