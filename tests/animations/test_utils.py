...
@pytest.mark.parametrize(
    "gap, contents, length, right, initial, expected_6",
    [
...
def test_extract_exactly_n_chars(text, default, expected):
    assert (
        "".join(chain.from_iterable(extract_fill_graphemes(text, default))) == expected
    )
...
@pytest.mark.parametrize(
    "actual_length, naturals, expected",
    [
        (2, (10,), (2,)),
        (8, (2, 2), (4, 4)),
        (14, (2, 4, 1), (4, 8, 2)),
